...
public class AccountAggregate {
    ...
    public AccountAggregate(CreateAccountCommand createAccountCommand) {
        ...
        if (createAccountCommand.getInitialBalance() < 0) {
            throw new NegativeInitialBalanceException("Saldo inicial negativo");
        }
    ...
    public void handle(CreditAccountCommand creditAccountCommand){
        ...
        if (creditAccountCommand.getAmount() < 0) {
            throw new NegativeInitialBalanceException("No se puede ingresar negativo");
        }
    ...
    public void handle(DebitAccountCommand debitAccountCommand){
        ...
        if (debitAccountCommand.getAmount() < 0) {
            throw new NegativeInitialBalanceException("No se puede retirar negativo");
        }
